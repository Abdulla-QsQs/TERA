...
- [ ] Confirm the Cloudflare Pages/Functions/D1 Free-plan deployment and record the live origin.
- [ ] Run `migrations/0001_tera.sql` on D1, verify retention, and confirm the public totals survive a clean redeploy.
